...
the last board in which all numbers in a row or column appear wins
...
with open("input.txt") as f:
    ...
    print(draw)
    print(winner)
    score = score(draw, boards[winner])
    print(score)
